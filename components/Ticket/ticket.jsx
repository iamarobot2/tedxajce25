...
const Ticket = () => {
  ...
  return (
    <div className=" bg-black/90 flex justify-center items-center  box-border p-10 md:p-16 border-0 md:border-2 border-red-600 rounded-[30px] relative  md:max-h-[600px] w-[90%] md:max-w-full mx-auto overflow-hidden">
